...
function actualizarEscenaResponsive() {
    fontSize = smallScreen.matches ? 14 : 20;
}

// ======================================

function iniciarLluvia(){
    actualizarEscenaResponsive();
...
for(let i=0;i<(smallScreen.matches ? 70 : 140);i++){
...
function explosionCorazones() {
    ...
    const total = smallScreen.matches ? 90 : 200;
